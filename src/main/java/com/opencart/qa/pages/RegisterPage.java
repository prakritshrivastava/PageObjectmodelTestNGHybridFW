...
public class RegisterPage {
	...
	public boolean userRegistration(String firstName,String lastName,String telephone,String password,String subscribe) {
		...
		eleUtil.waitForElementVisible(this.firstName, AppConstants.MEDIUM_TIME_OUT);
		...
		if(eleUtil.waitForElementVisible(successMessage, AppConstants.LONG_TIME_OUT).getText().contains(AppConstants.REGISTER_SUCCESS_MESSAGE)) {
